...
/**
 *class to initiate connection to data base
 * @author g55301
 */
public class DBManager {
    ...
    Connection getConnection() throws RepositoryException {
        ...
        String jdbcUrl = "jdbc:sqlite:data/sqlite/dbstib.db";
        if (connection == null) {
            try {
    ...
    void startTransaction() throws RepositoryException {
        try {
            ...
            throw new RepositoryException("Impossible de démarrer"
    ...
    void validateTransaction() throws RepositoryException {
        try {
            ...
            throw new RepositoryException("Impossible de valider "
    ...
    void cancelTransaction() throws RepositoryException {
        try {
            ...
            throw new RepositoryException("Impossible d'annuler "
                    + "la transaction: " + ex.getMessage());
        }
    }
