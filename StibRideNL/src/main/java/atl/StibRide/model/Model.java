...
public class Model implements Observable {
    ...
    public List<FavoryDto> initFavory() throws RepositoryException {
        return demoFav.getAll();
    }
